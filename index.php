...
<body>
	<div class = "navbar navbar-default" style="background-color:#89d20a;">
		<img src = "" style = "float:left;" height = "55px" /><span class = "navbar-brand">SSCT PERSONNEL PROFILING</span>
	</div>
	...
	<div id = "footer">
		<label class = "footer-title">&copy; Copyright SSCT PERSONNEL PROFILING 2021</label>
	</div>
</body>
<?php
	include("script.php");
